...
title: Plugins
---
hsiams comes with color overrides & extras for the following plugins.
...
If you use SweetAlert and load the SweetAlert CSS before hsiams's CSS, then the colors of any icon changes to hsiams's default colors.


### Toastr

If you use Toastr and load the Toastr CSS before hsiams's CSS, then the background colors changes to hsiams's default colors.

...
> ##### Tip!
> The [starter page](https://hsiams.io/themes/v3/starter.html) is a good place to start building your app if you'd like to start from scratch.
{: .quote-info .mt-0}
...
hsiams 3.2 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
Preloader to avoid [https://github.com/ColorlibHQ/hsiams/discussions/3319](https://github.com/ColorlibHQ/hsiams/discussions/3319)
...
hsiams 3.2 provides a dark mode option. You can add in body tag:
...
hsiams 3.2 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
...
> ###### New
> You can use override the link/accent color in hsiams, you can add `.accent-*` to `body`.
{: .quote-info}
